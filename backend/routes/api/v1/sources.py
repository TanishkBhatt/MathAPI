...
from backend.models.api.v1.sources import GetSourcesResponse
from backend.utils.database import get_db
from backend.controllers.api.v1.sources import get_sources
...
def sources(
    ...
    return get_sources(database, api_key, topic_id)