...
def home() -> dict[str, Any]:
    return {
        ...
        "help": {
            ...
            "explore_routes": "We have currently a total of 5 routes serving topics, explanations, worked examples, practice questions and formulae sheets with a limit of 100 requests per hour.",
            "contribution": "You can contribute a question or example through POST /contribute/ routes via a protected admin_token."
        },
